...
if ($result && $result->num_rows > 0) {
    while ($order = $result->fetch_assoc()) {
        ...
        echo '<tr>
                ...
                <td>' . (isset($order['completion_date']) ? date('M d, Y', strtotime($order['completion_date'])) : 'N/A') . '</td>
                <td><span class="status status-success">Completed</span></td>
                <td>
                    <button class="btn btn-outline view-completed-modal"
                        ...
                        data-admin-approved="' . htmlspecialchars($order['admin_approved_date'], ENT_QUOTES, 'UTF-8') . '"
                        data-processing="' . htmlspecialchars($order['processing_date'], ENT_QUOTES, 'UTF-8') . '"
                        data-pickup="' . htmlspecialchars($order['pickup_date'], ENT_QUOTES, 'UTF-8') . '"
                        data-shipping="' . htmlspecialchars($order['shipping_date'], ENT_QUOTES, 'UTF-8') . '"
                        data-delivered="' . htmlspecialchars($order['delivered_date'], ENT_QUOTES, 'UTF-8') . '"
                        data-completed="' . htmlspecialchars($order['completion_date'], ENT_QUOTES, 'UTF-8') . '">
                        View
                    </button>
                </td>
              </tr>';
