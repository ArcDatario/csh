...
try {
    ...
    $base_query = "FROM inventory";
    
    // Add search condition if provided
    if (!empty($search)) {
        $search_term = $conn->real_escape_string($search);
        $base_query .= " WHERE name LIKE '%$search_term%'";
    }
    ...
    $select_query = "SELECT id, name, quantity " . $base_query . " ORDER BY name ASC LIMIT $offset, $items_per_page";
