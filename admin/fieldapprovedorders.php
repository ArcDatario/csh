...
<body>
    ...
    $sql = "SELECT  orders.*, users.name, users.phone_number 
            ...
            INNER JOIN users ON orders.user_id = users.id 
             WHERE orders.is_user_approved = 'yes' 
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($order = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                    <div class="user-cell">
    <img src="../user/<?php echo htmlspecialchars($order['design_file'], ENT_QUOTES, 'UTF-8'); ?>" 
         alt="file design" 
         width="50" 
         height="50" 
         onclick="viewImageModal(this.src)">
...
<div id="quoteModal" class="quote-modal">
  <div class="quote-modal-content">
    ...
    <div class="quote-modal-body">
      ...
      <input type="text" id="order_id" class="order_id" name="order_id" hidden>
...
function handleViewButtonClick() {
    ...
    orderIdInput.value = id; // Pass the order ID here
...
function handleSaveQuote() {
    ...
    const orderId = orderIdInput.value; // Get the order ID
    ...
    formData.append('order_id', orderId); // Include the order ID in the request
...
function refreshDesignersTable() {
    fetch('functions/get_field_orders.php')
