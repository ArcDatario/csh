...
// --- Pagination setup ---
$items_per_page = 7; // Changed from orders_per_page to items_per_page
...
$select_query = "SELECT id, service_name, description, image FROM services ORDER BY id DESC LIMIT $offset, $items_per_page";
$services_result = $conn->query($select_query);
...
<body>
    <div class="container">
        ...
        <main class="main">
            <header class="header">
                <h1 class="header-dashboard">Services</h1>
            ...
            <section class="table-card fade-in">
                <div class="table-header">
                    <h3 class="table-title">Service Entries</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex; gap: 10px;">
                                                <button class="btn btn-outline edit-service" 
                                                        data-id="<?= $service['id'] ?>"
    ...
    <script>
            ...
            if (serviceForm.checkValidity()) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        window.location.href = 'services.php?page=1';
                    } else {
        ...
        // You'll need to include the showEditServiceModal and confirmDeleteService functions
        // from your services.js file here or include the script separately
