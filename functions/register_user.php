...
try {
    ...
    // Optional: Add more robust phone/address validation here
    ...
    $insert_query = "INSERT INTO users (email, name, password, phone_number, address, created_at";
    $values = "VALUES (?, ?, ?, ?, ?, NOW()";
    $params = ["sssss"]; // types for email, name, password, phone, address
